...
print(np.linalg.solve(np.dot(luMatrix.P, matrix), luMatrix.b))
print("\n det: ")
print(luMatrix.det())
print("\n L*U:")
...
print(np.linalg.inv(LU))
print("\n A*A^(-1): ")
print(np.dot(np.dot(luMatrix.P, matrix), luMatrix.inverse()))
print(np.dot(np.dot(luMatrix.P, matrix), np.linalg.inv(LU)))
print("\n cond: ")
print(luMatrix.cond())
